...
var newhr,sanhr,philadelphiahr,chicagohr,loshr,stlouishr;
var newmin,sanmin,philadelphiamin,losmin,stlouismin,chicagomin;

function preload(){
bg1=loadImage("weather.jpg")
bg2=loadImage("bg2.jpg");
bg3=loadImage("moon.jpg");
...
async function getnewTime(){
    var response=await fetch("http://api.weatherapi.com/v1/current.json?key=469320127ae8429099f105012212407&q&q=new%20york&aqi=no");
    var responseJSON=await response.json();
    var dateInfo=responseJSON.location;
    var dateInfoA=dateInfo.localtime;
    newhr=dateInfoA.slice(11,17)
}
async function getsanTime(){
    var response=await fetch("http://api.weatherapi.com/v1/current.json?key=469320127ae8429099f105012212407&q&q=san%20francisco&aqi=no");
    var responseJSON=await response.json();
    var dateInfo=responseJSON.location;
    var dateInfoA=dateInfo.localtime;
    sanhr=responseJSON.location.localtime.slice(11,17)
}
...
async function getchicagoTime(){
    ...
    var dateInfo=responseJSON.location;
    var dateInfoA=dateInfo.localtime;
    chicagohr=dateInfoA.slice(11,17)
}
async function getlosTime(){
    var response=await fetch("http://api.weatherapi.com/v1/current.json?key=469320127ae8429099f105012212407&q&q=los%20angeles&aqi=no");
    var responseJSON=await response.json();
    var dateInfo=responseJSON.location;
    var dateInfoA=dateInfo.localtime;
    loshr=dateInfoA.slice(11,17)

}
async function getstlouisTime(){
    var response=await fetch("http://api.weatherapi.com/v1/current.json?key=469320127ae8429099f105012212407&q&q=st%20louis&aqi=no");
    var responseJSON=await response.json();
    var dateInfo=responseJSON.location;
    var dateInfoA=dateInfo.localtime;
    stlouishr=dateInfoA.slice(11,17)
}
